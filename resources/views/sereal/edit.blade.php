    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-md-12">
            <div class="admin-card">
                <h2 class="admin-card-title">Edit Data Sereal & Nilai Gizi</h2>
                
                <form action="{{ route('sereal.update', $sereal->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                               value="{{ old('name', $sereal->name) }}" placeholder="Contoh: Nestle Koko Krunch" required>
                        @error('name')
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" 
                                               ...
                                               value="{{ old('kriteria_values.'.$kriteria->id, $currentValues[$kriteria->id] ?? '') }}" 
